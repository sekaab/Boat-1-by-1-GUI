...
function FuelDraw()
    ...
    Displacement = 2
        ...
        pumpLeftToRight = PrBu and isPointInRectangle(iX, iY, Centerline-Displacement, Uline - 1, 4, 3)
        pumpRightToLeft = PrBu and isPointInRectangle(iX, iY, Centerline+Displacement, Bline - 1, 4, 3)
